...
describe("geometry", () => {
  ...
  it("snaps to the canonical 5min grid", () => {
    expect(snapMinutes(9 * 60 + 2)).toBe(9 * 60)
    expect(snapMinutes(9 * 60 + 3)).toBe(9 * 60 + 5)
    expect(snapMinutes(9 * 60 + 57)).toBe(9 * 60 + 55)
    expect(snapMinutes(9 * 60 + 58)).toBe(10 * 60)
  })
})
